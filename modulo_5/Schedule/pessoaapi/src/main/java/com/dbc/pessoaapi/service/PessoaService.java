...
public class PessoaService {
    ...
    public void sendPessoaSemEndereco() throws MessagingException, TemplateException, IOException {
        List<PessoaEntity> pessoasSemEndereco = pessoaRepository.pessoasSemEndereco();
        for (PessoaEntity pessoa: pessoasSemEndereco){
            emailService.enviarEmailEndereco(pessoa);
        }
    }

    public void sendEmailNatal() throws MessagingException, TemplateException, IOException{
        List<PessoaEntity> todasPessoas = pessoaRepository.findAll();
        for(PessoaEntity pessoa: todasPessoas){
